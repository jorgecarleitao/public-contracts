...
_allAnalysis = [Analysis('municipalities_delta_time',
                ...
                Analysis('municipalities_contracts_time_series',
                         get_municipalities_contracts_time_series),
                Analysis('excluding_municipalities_contracts_time_series',
                         get_exclude_municipalities_contracts_time_series),
                ...
                Analysis('ministries_contracts_time_series', get_ministries_contracts_time_series),
